...
def main(): 
    ...
    parser.add_argument("--output_dir", type=str, default="data/cross_domain_results/")
    ...
    for base_model in base_model_map:
        ...
        if args.domain is not None:
            config_by_base_model = filter_configs(config_by_base_model, args.domain)
            ...
            for seed in args.seeds:
                ...
                if ft == "full": 
                    ...
                    if not eval_only:
                        ...
                        filename = f"lora_{module}_r{int(row['lora_rank'])}_model_outputs.json" 
                        tkn_gen_args = {
